...
export interface paths {
  ...
  "/api/public/ingestion": {
    ...
    get?: never;
    put?: never;
    /** @description Batched ingestion for Hanzo Tracing.
     *     If you want to use tracing via the API, such as to build your own Hanzo client implementation, this is the only API route you need to implement.
     *
     *     Within each batch, there can be multiple events.
     *     Each event has a type, an id, a timestamp, metadata and a body.
     *     Internally, we refer to this as the "event envelope" as it tells us something about the event but not the trace.
     *     We use the event id within this envelope to deduplicate messages to avoid processing the same event twice, i.e. the event id should be unique per request.
     *     The event.body.id is the ID of the actual trace and will be used for updates and will be visible within the Hanzo App.
...
export interface components {
  schemas: {
    ...
    CreateCommentResponse: {
      /** @description The id of the created object in Hanzo */
      id: string;
    };
    /** GetCommentsResponse */
    GetCommentsResponse: {
    ...
    Trace: {
      ...
      public?: boolean | null;
      /** @description The environment from which this trace originated. Can be any lowercase alphanumeric string with hyphens and underscores that does not start with 'hanzo'. */
      environment?: string | null;
    };
    /** TraceWithDetails */
    TraceWithDetails: {
      /** @description Path of trace in Hanzo UI */
      htmlPath: string;
      /**
       * Format: double
    ...
    Observation: {
      ...
      /** @description The environment from which this observation originated. Can be any lowercase alphanumeric string with hyphens and underscores that does not start with 'hanzo'. */
      environment?: string | null;
    };
    /** ObservationsView */
    ObservationsView: {
    ...
    BaseScore: {
      ...
      queueId?: string | null;
      /** @description The environment from which this score originated. Can be any lowercase alphanumeric string with hyphens and underscores that does not start with 'hanzo'. */
      environment?: string | null;
    };
    /** NumericScore */
    NumericScore: {
    ...
    /**
     * ModelUsageUnit
     * @description Unit of usage in Hanzo
     * @enum {string}
     */
    ...
    HealthResponse: {
      /**
       * @description Hanzo server version
       * @example 1.25.0
       */
      version: string;
      /** @example OK */
    ...
    BaseEvent: {
      ...
      timestamp: string;
      /** @description Optional. Metadata field used by the Hanzo SDKs for debugging. */
      metadata?: unknown;
    };
    /** TraceEvent */
    TraceEvent: {
    ...
    /** GetMediaResponse */
    GetMediaResponse: {
      /** @description The unique hanzo identifier of a media record */
      mediaId: string;
    ...
    CreateScoreConfigRequest: {
       ...
       */
      maxValue?: number | null;
      /** @description Description is shown across the Hanzo UI and can be used to e.g. explain the config categories in detail, why a numeric range was set, or provide additional context on config name or usage */
      description?: string | null;
    };
    /** CreateScoreRequest */
    CreateScoreRequest: {
      ...
      dataType?: components["schemas"]["ScoreDataType"];
      /** @description Reference a score config on a score. The unique hanzo identifier of a score config. When passing this field, the dataType and stringValue fields are automatically populated. */
      configId?: string | null;
    };
    /** CreateScoreResponse */
    CreateScoreResponse: {
...
export interface operations {
  ...
  "comments_get-by-id": {
    parameters: {
      ...
      header?: never;
      path: {
        /** @description The unique hanzo identifier of a comment */
        commentId: string;
      };
      cookie?: never;
    };
  ...
  observations_get: {
    parameters: {
      ...
      header?: never;
      path: {
        /** @description The unique hanzo identifier of an observation, can be an event, span or generation */
  ...
  promptVersion_update: {
    ...
    requestBody: {
      content: {
        "application/json": {
          /** @description New labels for the prompt version. Labels are unique across versions. The "latest" label is reserved and managed by Hanzo. */
          newLabels: string[];
        };
      };
    };
  ...
  "scoreConfigs_get-by-id": {
    parameters: {
      ...
      header?: never;
      path: {
        /** @description The unique hanzo identifier of a score config */
        configId: string;
      };
      cookie?: never;
    };
  ...
  "score_get-by-id": {
    parameters: {
      ...
      header?: never;
      path: {
        /** @description The unique hanzo identifier of a score */
        scoreId: string;
      };
      cookie?: never;
    };
  ...
  trace_get: {
    parameters: {
      ...
      header?: never;
      path: {
        /** @description The unique hanzo identifier of a trace */
        traceId: string;
      };
      cookie?: never;
    };
