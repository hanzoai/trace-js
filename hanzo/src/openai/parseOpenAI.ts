...
import type { CreateHanzoGenerationBody, Usage, UsageDetails } from "hanzo-core";
...
export const parseCompletionOutput = (res: unknown): CreateHanzoGenerationBody["output"] => {
