...
export interface ApiCreateCommentResponse {
  /** The id of the created object in Hanzo */
  id: string;
}
...
export interface ApiTrace {
  ...
  public?: boolean | null;
  /** The environment from which this trace originated. Can be any lowercase alphanumeric string with hyphens and underscores that does not start with 'hanzo'. */
  environment?: string | null;
}

/** TraceWithDetails */
export type ApiTraceWithDetails = ApiTrace & {
  /** Path of trace in Hanzo UI */
  htmlPath: string;
  /**
...
export interface ApiObservation {
  ...
  /** The environment from which this observation originated. Can be any lowercase alphanumeric string with hyphens and underscores that does not start with 'hanzo'. */
  environment?: string | null;
}
...
export interface ApiBaseScore {
  ...
  queueId?: string | null;
  /** The environment from which this score originated. Can be any lowercase alphanumeric string with hyphens and underscores that does not start with 'hanzo'. */
  environment?: string | null;
}
...
export interface ApiBaseEvent {
  ...
  timestamp: string;
  /** Optional. Metadata field used by the Hanzo SDKs for debugging. */
  metadata?: any;
}
...
export interface ApiGetMediaResponse {
  /** The unique hanzo identifier of a media record */
  mediaId: string;
...
export interface ApiCreateScoreConfigRequest {
   ...
   */
  maxValue?: number | null;
  /** Description is shown across the Hanzo UI and can be used to e.g. explain the config categories in detail, why a numeric range was set, or provide additional context on config name or usage */
  description?: string | null;
}
...
export interface ApiCreateScoreRequest {
  ...
  dataType?: ApiScoreDataType | null;
  /** Reference a score config on a score. The unique hanzo identifier of a score config. When passing this field, the dataType and stringValue fields are automatically populated. */
  configId?: string | null;
}
...
export interface ApiPromptVersionUpdatePayload {
  /** New labels for the prompt version. Labels are unique across versions. The "latest" label is reserved and managed by Hanzo. */
  newLabels: string[];
}
 ...
 */
export class HanzoPublicApi<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
    /**
    ...
    /**
     * @description Get daily metrics of the Hanzo project
     *
     * @tags Metrics
     * @name MetricsDaily
    ...
    /**
     * @description Delete a model. Cannot delete models managed by Hanzo. You can create your own definition with the same modelName to override the definition though.
     *
     * @tags Models
     * @name ModelsDelete
